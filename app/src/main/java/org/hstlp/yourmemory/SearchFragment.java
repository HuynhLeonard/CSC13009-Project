...
public class SearchFragment extends ImageDisplay {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        listAdapter.getFilter().filter(""); //Refresh the filter in listAdapter
        ...
        searchView.setIconifiedByDefault(false); //set icon search display after cursor
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                listAdapter.getFilter().filter(s);  //Set filter for list adapter to sort image
                return false;
            }

            @Override
            public boolean onQueryTextChange(String s) {
                if (s.isEmpty()) { //Case if search string is null
                    isSearch = false;
                    recyclerView.setVisibility(View.GONE);
                } else { //Case if search string is not null
                    isSearch = true;
        ...
        LinearSnapHelper snapHelper = new LinearSnapHelper();  //Helping snap the item to center the screen
