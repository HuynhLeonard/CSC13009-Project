...
import org.hstlp.yourmemory.Callback.ZoomCallBack;
import org.hstlp.yourmemory.Ultilities.ImageUltility;

import java.io.File;
import java.util.ArrayList;

public class SelectedViewPagerAdapter extends RecyclerView.Adapter<SelectedViewPagerAdapter.ViewHolder> implements ZoomCallBack {
    ArrayList<SelectedViewPagerItem> arrayItems;
    SelectedPicture main;
    private static final String TAG = "Touch";
    @SuppressLint("StaticFieldLeak")
    static SelectedViewPagerAdapter instance = null;
    ...
    public SelectedViewPagerAdapter(ArrayList<SelectedViewPagerItem> arrayItems, SelectedPicture main) {
        this.main = main;
...
//                    Toast.makeText(main, "allow", Toast.LENGTH_SHORT).show();
    ...
    public SelectedViewPagerItem getItem(int position) {
